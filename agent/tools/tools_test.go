...
func TestFileTools(t *testing.T) {
	...
	if err != nil {
		...
		} else if string(content) != "Written by nanotalon!" {
			t.Errorf("File content mismatch: got %s, want %s", string(content), "Written by nanotalon!")
		} else {
